...
On ActiveRecord objects you will use permits?
    ...
    Customer.permits? :create         # does the current user have permission to create customers?
    @account.permits? :edit, @client  # is current user allowed to edit the account associated with the client?
